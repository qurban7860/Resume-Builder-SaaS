    ...
    <div className="bg-white" style={{ fontFamily: SANS, color: '#1e1b4b' }}>
      ...
      {sections.summary?.content && (
        <section className="mb-2.5">
          ...
          <p style={{ fontSize: '10.5px', lineHeight: '1.5', color: '#374151' }}>{sections.summary.content}</p>
        </section>
      )}
              ...
              <div key={item.id}>
                ...
                {item.summary && (
                  <div
                    ...
                    style={{ fontSize: '10.5px', color: '#374151', marginTop: '3px', lineHeight: '1.45' }}
            ...
            {sections.projects.items.map((proj: any) => {
              ...
              return (
                <div key={proj.id}>
                  ...
                  {isHtml ? (
                    <div className="[&_ul]:list-disc [&_ul]:pl-4 [&_li]:list-item [&_li]:mb-[2px]" style={{ fontSize: '10.5px', color: '#374151', marginTop: '3px', lineHeight: '1.45' }} dangerouslySetInnerHTML={{ __html: proj.description }} />
                  ) : (
                    <ul style={{ fontSize: '10.5px', color: '#374151', marginTop: '3px', paddingLeft: '16px', lineHeight: '1.45', listStyleType: 'disc' }}>
