...
const sz = 'w-[10px] h-[10px] inline-block mr-[3px] flex-shrink-0 translate-y-[1px]';
...
const LinkIcon     = () => <svg className="w-[8px] h-[8px] fill-none stroke-current inline ml-0.5 opacity-60" strokeWidth="2.5" viewBox="0 0 24 24"><path d="M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>;
